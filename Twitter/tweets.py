...
################################################################################
twitter_credentials = {
    'consumer_key': 'HVDKVTpIsdEfmggHtNZh9nw3g',
    'consumer_secret': 'qwDOLPzldXYesaXdA9iFsjRJJ9FxchF87Gi7gEcQmcw4zIlvcF',
    'access_token': '754439843116118021-z9e7p5scTyKDac4YxqXVzPXr2YT4KLx',
    'access_token_secret': '8WDSBPLAyW8gb5uL3aJMImWE2R42K0BBprIghHuZ8ZsNs'
}
...
class Tweets(Spout):
    ...
    def initialize(self, stormconf, context):
        ...
        # define a list of things to track
        #in this case collect on NGOs 
        tracking_list=['#socialgood', '#socialchange', '#volunteer', '#4hange',
                         '#giveback', '#dogood', '#nonprofit']
